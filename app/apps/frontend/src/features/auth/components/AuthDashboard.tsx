      ...
      <div className="max-w-md w-full space-y-8 animate-premium-in">
        ...
        <div className="flex flex-col items-center space-y-4">
          <div className="relative group">
            ...
            <Logo variant="full" className="h-20 sm:h-24 relative transition-premium grayscale hover:grayscale-0 opacity-80 hover:opacity-100" />
          </div>
          <div className="text-center space-y-1">
            <h1 className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">Terminal de Operaciones</h1>
            <p className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground/30">Secure Financial Interface v1.0</p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center px-2 opacity-20">
          <span className="text-[8px] font-mono font-black uppercase tracking-tighter">Auth.Node: Mendoza_ARG</span>
          <span className="text-[8px] font-mono font-black uppercase tracking-tighter">Encr: AES-256-GCM</span>
        </div>
      </div>
    </div>
  );

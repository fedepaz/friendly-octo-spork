    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-end gap-2">
          ...
          <span className="text-[10px] font-bold mb-1.5 opacity-50">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-muted/30 p-3 border border-border">
          <div className="flex justify-between items-center mb-2">
            <span className="text-[10px] font-bold">ESTADO DE CUOTAS</span>
      ...
      <div className="grid grid-cols-1 gap-2">
        <div className="flex items-center justify-between p-2 bg-background border border-border font-mono text-[10px]">

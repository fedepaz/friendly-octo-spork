...
const EmptyState: FC = () => (
  <div id="accounts-list" class="bg-card text-card-foreground border-2 border-border shadow-[var(--shadow-lg)] p-16 text-center">
...
export function AccountsList({ accounts }: { accounts: Account[] }) {
  ...
  return (
    <div id="accounts-list" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

...
export function RecurrenceForm() {
  return (
    <div class="bg-card text-card-foreground border-2 border-border shadow-[var(--shadow-lg)] p-6 w-full max-w-md">
      <h3 class="text-2xl font-bold mb-4 uppercase tracking-wider">CREATE NEW RECURRENCE</h3>
      ...
      >
        <div>
          <label for="name" class="block text-sm font-semibold uppercase mb-2">Recurrence Name</label>
          <input
            type="text"
            name="name"
            id="name"
        ...
        <div>
          <label for="frequency" class="block text-sm font-semibold uppercase mb-2">Recurrence Type</label>
          <select
            name="frequency"
            id="frequency"
            required
        ...
        <div>
          <label for="totalParts" class="block text-sm font-semibold uppercase mb-2">Total Parts</label>
          <input
            type="number"
            name="totalParts"
            id="totalParts"
        ...
        <div>
          <label for="currentPart" class="block text-sm font-semibold uppercase mb-2">Current Part</label>
          <input
            type="number"
            name="currentPart"
            id="currentPart"
        ...
        <div>
          <label for="nextDate" class="block text-sm font-semibold uppercase mb-2">Next Date</label>
          <input
            type="date"
            name="nextDate"
            id="nextDate"
